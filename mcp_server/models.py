...
class OtcerCertificatePostRequest(BaseModel):
...
class OtcerCertificatePostResponse(BaseModel):
...
class OtcerCertificatePostResponse1(BaseModel):
...
class OtcerCertificatePostResponse2(BaseModel):
...
class OtcerCertificatePostResponse3(BaseModel):
...
class OtcerCertificatePostResponse4(BaseModel):
...
class OtcerCertificatePostResponse5(BaseModel):
...
class OtcerCertificatePostResponse6(BaseModel):
